		...
		<div class="container">
			<div class="row section group">
				<div class="col-md-4">
					...
					<form method="POST" id="cadastroNewsletter" class="subscribe" action="php/cadastrarnews.php">
						<input type="text" name="email" value="Digite seu e-mail" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Insert Email';}">
					</form>
					<div class="subscribe1">
						<a href="javascript:{}" onclick="document.getElementById('cadastroNewsletter').submit(); return false;" >Enviar e-mail<i class="but_arrow"> </i></a>
					</div>
				</div>
				<div class="col-md-4">
					<div class="f-logo">
